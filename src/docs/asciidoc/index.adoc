...
:facility: ../../../gh-domain/gh-facility/gh-facility-api/build/generated-snippets/facility-read
endif::[]
= Golden Home API 문서
:doctype: book
:icons: font
...
== 시설 상세조회
=== HTTP Request
include::{facility}/http-request.adoc[]
include::{facility}/path-parameters.adoc[]

=== HTTP Response
include::{facility}/http-response.adoc[]
include::{facility}/response-fields.adoc[]