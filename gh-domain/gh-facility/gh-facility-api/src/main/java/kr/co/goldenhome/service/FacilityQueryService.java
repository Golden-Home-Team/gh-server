...
public class FacilityQueryService {
    ...
    public List<FacilityResponse> readAll(String name, String address, String facilityType, String grade, String sort, int withinYears, int page, int size,
...
//        return readAll(name, address, facilityType, grade, sort, withinYears, page, size, latitude, longitude, radiusKm, userPrincipal);
//    }
//
