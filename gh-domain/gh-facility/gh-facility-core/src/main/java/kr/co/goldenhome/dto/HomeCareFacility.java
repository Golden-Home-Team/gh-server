...
@Table(name = "home_care_facilities")
@Entity
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class HomeCareFacility { // 요양원
    ...
    @Builder
    private HomeCareFacility(Long id, String districtName, String name, String director, Integer capacity, Integer currentTotal, Integer currentMale, Integer currentFemale, Integer staffTotal, Integer staffMale, Integer staffFemale, String address, String phoneNumber, String establishmentDate, String operatingBody) {
        this.id = id;
    ...
    public static HomeCareFacility from(Facility facility) {
        return HomeCareFacility.builder()
                .id(facility.getId())
