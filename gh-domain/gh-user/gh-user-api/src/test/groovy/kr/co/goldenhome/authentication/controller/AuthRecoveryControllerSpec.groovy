...
class AuthRecoveryControllerSpec extends Specification {
    ...
    def "계정 찾기 - 인증확인"() {
        given:
        def request = new VerificationConfirmRequest("EMAIL", "gucoding1234@google.com", "12345678", "gucoding1234")
        def expectedResponse = new VerificationConfirmResponse(LocalDateTime.of(2000, 1, 1, 10, 10), "gucoding1234", "abcd-1234")
        ...
        response.andExpect {
            ...
            MockMvcResultMatchers.jsonPath('$.resetPasswordToken').value("abcd-1234")
        }
    ...
    def "비밀번호 재설정"() {
        given:
        def request = new ResetPasswordRequest("edubejbfe23", "test1234", "1234", "1234")
