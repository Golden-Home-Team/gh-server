...
@Table(name = "visiting_nursings")
@Entity
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class VisitingNursing {
    ...
    @Builder
    private VisitingNursing(Long id, String districtName, String name, String director, Integer capacity, Integer currentTotal, Integer currentMale, Integer currentFemale, Integer staffTotal, Integer staffMale, Integer staffFemale, String address, String phoneNumber, String establishmentDate, String operatingBody) {
        this.id = id;
    ...
    public static VisitingNursing from(Service facility) {
        return VisitingNursing.builder()
                .id(facility.getId())
