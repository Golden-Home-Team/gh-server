...
import kr.co.goldenhome.implement.ReviewMetadataUpdater;
...
public class ReviewListener {
    ...
    private final ReviewMetadataUpdater reviewMetadataUpdater;
    ...
    public void increaseElasticSearchReviewCount(@Payload SqsMessage sqsMessage) throws JsonProcessingException {
        ...
        reviewMetadataUpdater.processReviewEvent(facilityEvent);
    }
}
