...
:get-pre-signed-url-for-uploady: ../../../gh-domain/gh-file/gh-file-api/build/generated-snippets/get-pre-signed-url-for-upload
endif::[]
= Golden Home API 문서
:doctype: book
:icons: font
...
== Pre-Signed URL 요청
=== HTTP Request
include::{get-pre-signed-url-for-uploady}/http-request.adoc[]
include::{get-pre-signed-url-for-uploady}/request-fields.adoc[]

=== HTTP Response
include::{get-pre-signed-url-for-uploady}/http-response.adoc[]
include::{get-pre-signed-url-for-uploady}/response-fields.adoc[]