...
@Table(name = "visiting_cares")
@Entity
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class VisitingCare {
    ...
    @Builder
    private VisitingCare(Long id, String districtName, String name, String director, Integer capacity, Integer currentTotal, Integer currentMale, Integer currentFemale, Integer staffTotal, Integer staffMale, Integer staffFemale, String address, String phoneNumber, String establishmentDate, String operatingBody) {
        this.id = id;
    ...
    public static VisitingCare from(Service facility) {
        return VisitingCare.builder()
                .id(facility.getId())
